  ...
  return (
    <main className="min-h-screen bg-bm-bg text-bm-text">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col gap-8 px-5 pb-16 pt-6 lg:flex-row lg:gap-10 lg:px-10 lg:pt-24">
          ...
          <div className="order-2 mt-4 flex items-center justify-center lg:order-1 lg:mt-0 lg:w-44 lg:items-start">
            <SystemLayerSelector />
          </div>
